package kr.hmit.afbis.ui.main_dashboard;
...
import kr.hmit.afbis.databinding.FragmentMainDashboardBinding;
...
public class MainDashboardFragment extends Fragment {
    ...
    private void initLayout() {
        if (BuildConfig.DEBUG) {
            binding.tvValueTemperature.setText("90℃");
            binding.tvValueHumidity.setText("90%");
            binding.tvValueHumidity.setSelected(true);
        }
    }
}
